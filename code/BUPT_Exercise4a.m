function [] = BUPT_Exercise4a(noise_type, sigma)
 

lena=imread('../dataset/test_images/Lena512_Binary2014.pgm');
peppers=imread('../dataset/test_images/Peppers512_binary2014.pgm');
baboon=imread('../dataset/test_images/Baboon512_binary2014.pgm');
[h1, w1] = size(lena);
[h2, w2] = size(peppers);
[h3, w3] = size(baboon);
...
imwrite(Img_noise1,'../results/output/exercise4a/Img_noise1.jpg');
subplot(1,3,2)
imshow(Img_noise2)
title(strcat('MSE=',num2str(MSE2),', PSNR=',num2str(PSNR2)));
imwrite(Img_noise2,'../results/output/exercise4a/Img_noise2.jpg');
subplot(1,3,3)
imshow(Img_noise3)
title(strcat('MSE=',num2str(MSE3),', PSNR=',num2str(PSNR3)));
imwrite(Img_noise3,'../results/output/exercise4a/Img_noise3.jpg');
end
